...
* **💬 你问我答（qa.html）**：日常 / 乘务员手册 01.10 / 管理手册 01.14 / 服务规范 00.07 / 大撤专项 / CBT 题库 **六库**知识问答；话术向导（**直接说产品名出稿**，结果卡可 **🔁 换个风格** 换版）；绩效查询、在线练习、实时天气、历史与联想记忆、点赞/吐槽/改良答案（纯本机）。**本地知识库模式：零密钥、零外发。**
